...
const Signup = () => {
  ...
  const [creds, setCreds] = useState<Authentication>(defaultCreds);
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setCreds((prev) => ({ ...prev, [event.target.id]: event.target.value }));
  };
      ...
      <div className="w-100" style={{ maxWidth: "400px" }}>
        ...
        <div className="card shadow rounded-4">
          <div className="card-body">
            <div className="card-title text-center fw-semibold fs-2">
              Signup
            </div>
